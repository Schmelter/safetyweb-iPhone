...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *drawViewController = [[DrawViewController alloc] initWithNibName:@"DrawViewController" bundle:nil];
    UITabBarController *aTabBarController = [[UITabBarController alloc] init];
    self.tabBarController = aTabBarController;
    self.tabBarController.viewControllers = [NSArray arrayWithObjects:coordinateViewController, buttonDrivenViewController, quartzMapViewController, drawViewController, nil];
